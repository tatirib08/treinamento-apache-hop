...
2. Criação do banco: foi utilizada a ferramenta HeidiSQL, na qual o database BD_PESQUISADOR foi criado. O script de criação das tabelas está no arquivo population_script.sql
